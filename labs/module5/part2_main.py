...
Title: Module 5 Part 2 — Navigate Easy Maze
"""
...
import drone_core
from part2_tasks import step1_init, step2_navigate

drone = drone_core.create_drone()
_TASKS = [("Init", step1_init), ("Navigate Easy Maze", step2_navigate)]
_task_index = 0

def start():
    global _task_index
    _task_index = 0; _TASKS[0][1].reset()
    print("\n=== Module 5 Part 2: Easy Maze ===\n")
