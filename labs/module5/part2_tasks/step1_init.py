"""Module 5 Part 2 — Step 1: Init (same as Part 1 — provided complete)"""
import sys, os
...
def update(drone):
    ...
    if _phase == 0:
        ...
        if abs(err) < 0.12:
            drone.flight.stop(); print(f"[Part2 Step 1] Ready at {drone.physics.get_altitude():.2f}m"); _done = True
        else:
